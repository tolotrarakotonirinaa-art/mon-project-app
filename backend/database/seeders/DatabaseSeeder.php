    ...
    public function run(): void
    {
        ...
        $users = [
            ...
            [
                ...
                'role'         => 'dev',
                'avatar'       => 'JD',
                'bio'          => 'Developpeur fullstack React/Node.js',
            ...
            [
                ...
                'role'         => 'dev',
                'avatar'       => 'MD',
                'bio'          => 'Developpeuse frontend specialisee React',
            ...
            [
                ...
                'role'         => 'dev',
                'avatar'       => 'JM',
                'bio'          => 'Ingenieur backend Node.js/MongoDB',
            ...
            [
                ...
                'role'         => 'client',
                'avatar'       => 'SL',
                'bio'          => 'Chef de projet cote client',
        ...
        $projects = [
            ...
            [
                ...
                'description' => 'Dashboard temps reel avec WebSocket',
                'status'      => 'active',
                'progress'    => 45,
        ...
        // ── 5. ENVIRONMENTS ──────────────────────────────────────
        $envs = [
            ['name' => 'Developpement', 'type' => 'dev',        'status' => 'running', 'url' => 'https://dev.example.com',     'version' => '1.3.0', 'last_deploy' => '2024-11-05', 'cpu' => 23, 'memory' => 45, 'created_by' => 1],
        ...
        $logs = [
            ['time' => '14:30:01', 'text' => 'Demarrage pipeline CI/CD v2.1.0',  'level' => 'info'],
            ['time' => '14:30:12', 'text' => 'Recuperation depuis origin/main',  'level' => 'success'],
            ['time' => '14:31:05', 'text' => 'npm install (125 packages)',        'level' => 'success'],
            ['time' => '14:33:20', 'text' => 'Tests unitaires en cours...',       'level' => 'info'],
            ['time' => '14:35:44', 'text' => '152 tests passes - 0 echecs',       'level' => 'success'],
        ...
        // ── 7. CHAT MESSAGES ─────────────────────────────────────
        $messages = [
            ['sender' => 'Marie Dubois', 'avatar' => 'MD', 'message' => 'Bonjour! Les tests v1.3 sont prets', 'channel' => 'general', 'time' => '14:20', 'user_id' => 3],
            ['sender' => 'Admin User',   'avatar' => 'AU', 'message' => 'Super! Je prepare le deploiement.',  'channel' => 'general', 'time' => '14:22', 'user_id' => 1],
        ...
        // ── 8. ACTIVITIES ─────────────────────────────────────────
        $activities = [
            ['user' => 'Marie Dubois', 'action' => 'a pousse du code sur frontend-ecommerce', 'icon' => 'code-branch',  'time' => 'Il y a 15 min', 'color' => '#00c8ff', 'user_id' => 3],
            ['user' => 'Jean Martin',  'action' => 'a complete Implementer API REST',          'icon' => 'check-circle', 'time' => 'Il y a 1h',     'color' => '#00ff88', 'user_id' => 4],
            ['user' => 'Admin User',   'action' => 'a deploye v1.3.0 en developpement',        'icon' => 'rocket',       'time' => 'Il y a 3h',     'color' => '#ff6b35', 'user_id' => 1],
        ];
        ...
        // ── 9. NOTIFICATIONS ──────────────────────────────────────
        $notifications = [
            ['type' => 'task',    'message' => 'Nouvelle tache assignee : Corriger bug login', 'read' => false, 'time' => '10 min', 'user_id' => 1],
            ['type' => 'deploy',  'message' => 'Deploiement v1.3.0 termine avec succes',       'read' => false, 'time' => '3h',     'user_id' => 1],
            ['type' => 'mention', 'message' => 'Marie Dubois vous a mentionne dans #general',  'read' => true,  'time' => '1 jour', 'user_id' => 1],
        ];
        ...
        $this->command->info('Utilisateurs crees : admin, dev (x3), client');
        $this->command->info('Projets : 4 | Taches : 7 | Depots : 4 | Environnements : 3');
    }
}